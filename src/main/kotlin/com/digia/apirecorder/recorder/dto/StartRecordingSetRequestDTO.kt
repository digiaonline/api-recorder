...
data class UrlToRecord(val url : String, val parameters : Array<ParametersDTO>?, val period : Int, val body : String?, val headers : Map<String, String>?, val method : String = "GET", val feedItemPath : String?) {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (javaClass != other?.javaClass) return false
